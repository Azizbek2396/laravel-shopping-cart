...
<div class="container">
    <div class="starter-template">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/products/iphone_x_silver.jpg" alt="iPhone X 256GB">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/products/htc_one_s.png" alt="HTC One S">
                    <div class="caption">
                        <h3>HTC One S</h3>
                        <p>12490 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/products/iphone_5.jpg" alt="iPhone 5SE">
                    <div class="caption">
                        <h3>iPhone 5SE</h3>
                        <p>17221 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/products/beats.jpg" alt="Наушники Beats Audio">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/products/gopro.jpg" alt="Камера GoPro">
                    <div class="caption">
                        <h3>Камера GoPro</h3>
                        <p>12000 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/products/video_panasonic.jpg" alt="Камера Panasonic HC-V770">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/products/delongi.jpg" alt="Кофемашина DeLongi">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/products/haier.jpg" alt="Холодильник Haier">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/products/moulinex.jpg" alt="Блендер Moulinex">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/products/bosch.jpg" alt="Мясорубка Bosch">
                    <div class="caption">
